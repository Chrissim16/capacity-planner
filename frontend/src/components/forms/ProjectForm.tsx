...
export function ProjectForm({ isOpen, onClose, project }: ProjectFormProps) {
 ...
 rows={2}
 className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0ED3CF] resize-none"
 />
 </div>
 ...
 {isPhaseExpanded && (
 <div className="px-10 pb-3 space-y-3 border-t border-slate-200 pt-3">
...
function BizPanel({
 ...
 <div>
 <label className="block text-[10px] font-medium text-slate-500 mb-1 uppercase tracking-wide">Days committed</label>
 <input
 type="number"
 min="0.5"
 step="0.5"
 ...
 <button type="button" onClick={onHideAddForm} className="text-xs text-slate-500 hover:text-slate-700 dark:hover:text-slate-200 px-2 py-1 transition-colors">
 Cancel
 </button>
 <button
 type="button"
