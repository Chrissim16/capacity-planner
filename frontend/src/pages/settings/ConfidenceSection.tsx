...
export function ConfidenceSection() {
 ...
 <span className="text-[9px] font-bold uppercase tracking-wider px-1 py-0.5 rounded bg-white/60">
 default
 </span>
 )}
 </span>
 ...
 <label className="text-xs text-[#94A3B8] whitespace-nowrap">
 Buffer
 </label>
 ...
 className="w-full pr-7 pl-3 py-1.5 text-sm font-semibold rounded-lg border border-[#94A3B8] bg-white text-[#1E293B] focus:outline-none focus:ring-2 focus:ring-[#0089DD] text-right"
 />
 <span className="absolute right-2.5 top-1/2 -translate-y-1/2 text-sm text-[#94A3B8] pointer-events-none">%</span>
 </div>
 ...
 : 'bg-white text-[#94A3B8] border-[#94A3B8] hover:border-[#0089DD] hover:text-[#0089DD]'
 }`}
 >
 ...
 {/* Example calculation */}
 <div className="rounded-lg bg-[#F0F2F5] /50 border border-[#DEDFE3] p-3 text-xs text-[#94A3B8] space-y-1">
 <p className="font-semibold text-[#94A3B8] ">Example</p>
