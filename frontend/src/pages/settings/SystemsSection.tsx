...
export function SystemsSection() {
 ...
 {systems.map((system) => (
 <div key={system.id} className="flex items-center justify-between p-3 bg-[#F5F3F0] /50 rounded-lg">
 {editingId === system.id ? (
 ...
 <button onClick={() => startEdit(system.id)} className="p-1.5 text-slate-400 hover:text-[#0ED3CF]"><Edit2 size={16} /></button>
