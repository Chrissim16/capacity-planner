...
export function JiraConnectionForm({ connection, onSave, onCancel }: JiraConnectionFormProps) {
 ...
 <div className="flex-1 px-3 py-2 rounded-lg border border-slate-200 bg-slate-50 text-slate-500 font-mono text-sm">
 ...
 className="w-20 px-3 py-1.5 text-sm border border-slate-300 rounded-lg bg-white text-slate-900 dark:text-slate-100"
 />
 ...
 className="w-full px-3 py-2 text-sm border border-slate-300 rounded-lg bg-white text-slate-900 dark:text-slate-100 placeholder-slate-400 font-mono"
 />
 <p className="text-xs text-slate-500 mt-1">
 ...
 className="w-full px-3 py-1.5 text-sm border border-slate-300 rounded-lg bg-white text-slate-900 dark:text-slate-100 placeholder-slate-400 font-mono"
 />
 </div>
 ))}
 </div>
