...
export function AssignmentModal({ 
 ...
 ? 'bg-white dark:bg-slate-600 text-slate-900 shadow-sm'
 : 'text-slate-600 '
 }`}
 >
 <Calendar size={14} />
 ...
 <div className="p-4 bg-slate-50 /50 rounded-lg space-y-4">
 ...
 : 'bg-slate-50 border-slate-200 hover:border-yellow-300'
 }`}
 >
 ...
 isSelected
 ? 'bg-[#E8F8F8] border-2 border-[#0ED3CF]'
 : 'bg-[#F5F3F0] border-2 border-transparent hover:border-[#E5E5E3]'
 }`}
 >
 <div className={`w-4 h-4 rounded border-2 flex-shrink-0 flex items-center justify-center ${
 isSelected ? 'bg-[#0ED3CF] border-[#0ED3CF]' : 'border-[#D1D5DB]'
 }`}>
