...
export function HolidaysSection() {
 ...
 <a href="https://date.nager.at" target="_blank" rel="noopener noreferrer" className="text-[#0ED3CF] hover:underline">Nager.Date</a> API.
 ...
 return (
 <div key={country.id} className="border-t border-slate-200 pt-4 first:border-t-0 first:pt-0">
 ...
 <div key={holiday.id} className="flex items-center justify-between p-2 bg-[#F5F3F0] /50 rounded-lg text-sm">
 <div className="flex items-center gap-3">
